        ...
        <div class="row">
            <div class="col-xs-1 col-lg-1">
                    <div class="contenedor col-xs-1 col-lg-1">
                        ...
                        <br>
                        <br>
                        <h2>Patente de automóvil que esta intentando ingresar al estacionamiento:</h2>
                        <br>
                        <br>
                        <form action="eleccionestacionamientoi.php" method="POST">
                                <input style='width:20%' type="text" minlength="6" maxlength="6" placeholder="patente" name="patente" required>
                                <br>
                                <button style='margin-top:5px' type=submit>Entrar al estacionamiento</button>
